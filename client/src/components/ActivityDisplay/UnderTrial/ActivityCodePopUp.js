...
const ActivityCodePopUp = ({ setActivityCode, setActivityOpen }) => {
  ...
  const appendData = () => {
    const updatedList = disciplineCode + subActivityCode; // Combine disciplineCode and year
          ...
          <div className="modal-body">
            ...
            <div>
              ...
              >
                ...
                <option value="SingleLineDrawings">Single Line Drawings</option>
                <option value="Specifications">Specifications</option>
                <option value="Structural">Structural</option>
                <option value="StructuralDrawings">Structural Drawings</option>
