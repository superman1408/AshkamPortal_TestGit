    ...
    <Card  className="flex flex-row justify-between p-4 ">
      ...
      <CardHeader className="flex flex-row shadow-2xl p-2 ">
        <div className='w-[90px] flex-wrap p-2'>
          <Avatar alt="avatar" src={ post?.selectedFile }  withBorder={true} color="green" className="p-0"/>
        </div>
      {/* </CardHeader> */}
      {/* <CardHeader> */}
        <div className="flex flex-col">
            <Typography variant="h5" color="blue" className='text-[24px]'>{post?.name}</Typography>
            <Typography variant="h6" color="pink"className='text-[12px]'>{post?.email}</Typography>
        </div>
      </CardHeader>
    </ButtonBase>
  </Card>
